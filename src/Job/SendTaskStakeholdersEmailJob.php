...
/**
 * A QueuedJob is specifically designed to be invoked when the task is marked as "Complete"
 * for tasks without approvals, and when the task is marked as "Waiting for approval" for tasks
 * with approvers
 */
